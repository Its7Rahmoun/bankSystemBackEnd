...
public class AuthenticationApi {
    ...
    public UserApp save(@RequestBody saveUserRequest user){
        return userAppService.saveuser(user.getNamecustomer(),user.getPassword(),user.getNamecustomer(),user.getRolename());
    }
}
