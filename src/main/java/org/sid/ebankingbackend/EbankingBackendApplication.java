...
import org.sid.ebankingbackend.repositories.*;
...
public class EbankingBackendApplication {
    ...
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService
        ...
        return args -> {
            ...
            Role r1 = roleRepository.save(new Role(null,"USER"));
            Role r2 =roleRepository.save(new Role(null,"ADMIN"));
            Role r3 =roleRepository.save(new Role(null,"MANADGER"));
           ...
           Stream.of("Hassan","Imane","Mohamed").forEach(name->{
               ...
               CustomerDTO c = bankAccountService.saveCustomer(customer);
           });
